...
def seed_dirty_data(conn: sqlite3.Connection) -> None:
    ...
    # Violation 4: Duplicate event_id in raw_events (no PK to prevent this)
    ...
    # Violation 5: Malformed JSON in payload column
    conn.execute(
        "INSERT INTO raw_events VALUES"
...
def main() -> None:
    ...
    conn.commit()
    conn.close()
    print(f"Created {DB_PATH} with 5 intentional data quality violations.")
